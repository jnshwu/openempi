...
public class NysiisFunction extends AbstractTransformationFunction
{
	...
	public Object transform(Object field) {
		log.debug("Applying the NYSIIS transform to field with value: " + field);
		if (field == null) {
			return null;
		}
		String encodedValue = nysiis.encode(field.toString());
		log.debug("The nysiis value for field: '" + field + "' is '" + encodedValue + "'");
		return encodedValue;
	}
}
