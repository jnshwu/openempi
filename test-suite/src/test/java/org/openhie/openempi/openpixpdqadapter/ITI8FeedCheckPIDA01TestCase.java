...
public class ITI8FeedCheckPIDA01TestCase extends AbstractPixTest
{
/*
		Pre-condition: 	
...
*/
	   public void testFeedCheckPIDA01() {
/*
 *		Messages:
 * 
...
*/
			try {
				...
				String message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160358||ADT^A01^ADT_A01|NIST-101101160358190|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("NIST-101101160358190", msa.getMessageControlID().getValue());
				
				
				
				//Step 2: Register patient JOHNSTON^ROBERT with RJ-438^^^&&ISO 
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160409||ADT^A01^ADT_A01|NIST-101101160409732|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("AE", msa.getAcknowledgementCode().getValue());
				assertEquals("NIST-101101160409732", msa.getMessageControlID().getValue());	
				
			} catch (Exception e) {
				e.printStackTrace();
				fail("Fail to test FeedCheckPIDA01.");
			}					
