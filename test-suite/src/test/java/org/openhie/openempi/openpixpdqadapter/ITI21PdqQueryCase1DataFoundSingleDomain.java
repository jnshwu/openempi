...
public class ITI21PdqQueryCase1DataFoundSingleDomain  extends AbstractPdqTest
{
/*
		Pre-condition: 	
		...
		Description:
		Test case ITI-21-Query-Case1-Data-Found-Single-Domain addresses PDQ Query Case 1. You need to have loaded the set of patients indicated in the pre-conditions into your system before running this test. The purpose of the test is to confirm that your PDQ Supplier supports the multiple query parameters. 		
 ...
 *		Messages:
 * 
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152141||QBP^Q22^QBP_Q21|NIST-101103152141480|T|2.5
		QPD|IHE PDQ Query|QRY12481848949|@PID.3.1^BL-180
		RCP|I
		
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152143||QBP^Q22^QBP_Q21|NIST-101103152143584|D|2.5
		QPD|IHE PDQ Query|QRY11849105448994|@PID.5.1.1^NXEAL~@PID.5.2^JERMAINO
		RCP|I
		
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152145||QBP^Q22^QBP_Q21|NIST-101103152145143|T|2.5
		QPD|IHE PDQ Query|QRY11011048808|@PID.5.1.1^NXEAL~@PID.7.1^19720306
		RCP|I
		
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152146||QBP^Q22^QBP_Q21|NIST-101103152146483|T|2.5
		QPD|IHE PDQ Query|QRY12400480880077|@PID.5.1.1^NXEAL~@PID.8^F|||||^^^NIST2010
		RCP|I
		
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152147||QBP^Q22^QBP_Q21|NIST-101103152147917|P|2.5
		QPD|IHE PDQ Query|QRY12489878110556|@PID.11.1.1^4670 Raver Croft Drive~@PID.11.3^HAMPTON~@PID.11.4^TN~@PID.11.5^37658
		RCP|I
		
		MSH|^~\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152149||QBP^Q22^QBP_Q21|NIST-101103152149242|P|2.5
		QPD|IHE PDQ Query|QRY581897987987897|@PID.18.1^1007240
		RCP|I
...
*/
			try {
				...
				//Step 1: Query for demographics with criteria PID.3.1=BL-180		
				String message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152141||QBP^Q22^QBP_Q21|NIST-101103152141480|T|2.5||||||||\r" + 
				...
				assertEquals("NIST-101103152141480", msa25.getMessageControlID().getValue());
				...
				//Step 2: Query for demographics with criteria PID.5.1.1=NXEAL and PID.5.2=JERMAINO 
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152143||QBP^Q22^QBP_Q21|NIST-101103152143584|D|2.5||||||||\r" + 
				...
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101103152143584", msa25.getMessageControlID().getValue());
				...
				//Step 3: Query for demographics with criteria PID.5.1.1=NXEAL and PID.7.1=19720306
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152145||QBP^Q22^QBP_Q21|NIST-101103152145143|T|2.5||||||||\r" + 
				...
				msa25 = (ca.uhn.hl7v2.model.v25.segment.MSA)response.get("MSA");
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101103152145143", msa25.getMessageControlID().getValue());
				qak = (ca.uhn.hl7v2.model.v25.segment.QAK)response.get("QAK");
				assertEquals("OK", qak.getQueryResponseStatus().getValue());
				...
				//Step 4: Query for demographics with criteria PID.5.1.1=NXEAL and PID.8=F  
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152146||QBP^Q22^QBP_Q21|NIST-101103152146483|T|2.5||||||||\r" + 
				...
				msa25 = (ca.uhn.hl7v2.model.v25.segment.MSA)response.get("MSA");
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101103152146483", msa25.getMessageControlID().getValue());
				qak = (ca.uhn.hl7v2.model.v25.segment.QAK)response.get("QAK");
				assertEquals("OK", qak.getQueryResponseStatus().getValue());
				...
				//Step 5: Query for demographics with criteria PID.11.1.1=4670 Raver Croft Drive and PID.11.3=HAMPTON and PID.11.4=TN and PID.11.5=37658 
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152147||QBP^Q22^QBP_Q21|NIST-101103152147917|P|2.5||||||||\r" + 
				...
				msa25 = (ca.uhn.hl7v2.model.v25.segment.MSA)response.get("MSA");
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101103152147917", msa25.getMessageControlID().getValue());
				qak = (ca.uhn.hl7v2.model.v25.segment.QAK)response.get("QAK");
				assertEquals("OK", qak.getQueryResponseStatus().getValue());
				...
				//Step 6: Query for demographics with criteria PID.18.1=0007240 
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101103152149||QBP^Q22^QBP_Q21|NIST-101103152149242|P|2.5||||||||\r" + 
				...
				msa25 = (ca.uhn.hl7v2.model.v25.segment.MSA)response.get("MSA");
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101103152149242", msa25.getMessageControlID().getValue());
				qak = (ca.uhn.hl7v2.model.v25.segment.QAK)response.get("QAK");
				assertEquals("OK", qak.getQueryResponseStatus().getValue());
