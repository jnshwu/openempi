...
public class ITI8FeedValidDomainA01TestCase extends AbstractPixTest
{
/*
		Pre-condition: 	
...
*/
	   public void testFeedValidDomainA01() {
/*
 *		Messages:
 * 
...
*/
			try {
				//Step 1
				String message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160641||ADT^A01^ADT_A01|NIST-101101160641914|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("NIST-101101160641914", msa.getMessageControlID().getValue());
				
				
				
				//Step 2
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160654||ADT^A01^ADT_A01|NIST-101101160654284|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("AA", msa.getAcknowledgementCode().getValue());
				assertEquals("NIST-101101160654284", msa.getMessageControlID().getValue());

				
	            //Step 3
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160655||QBP^Q23^QBP_Q21|NIST-101101160655565|P|2.5||||||||\r" + 
				...
				assertEquals("NIST-101101160655565", msa25.getMessageControlID().getValue());
				...
				//Step 4
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160705||ADT^A01^ADT_A01|NIST-101101160705951|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				msa = (MSA)response.get("MSA");
				assertEquals("AA", msa.getAcknowledgementCode().getValue());
				assertEquals("NIST-101101160705951", msa.getMessageControlID().getValue());		
				
				
				//Step 5
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160707||QBP^Q23^QBP_Q21|NIST-101101160707216|P|2.5||||||||\r" + 
				...
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101101160707216", msa25.getMessageControlID().getValue());
				...
				e.printStackTrace();
				fail("Fail to test FeedValidDomainA01.");
			}					
