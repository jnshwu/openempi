...
public class PdqMesa11340TestCase extends AbstractPdqTest
{
	/**
		Description
	 ...
	 */
	public void testPdqMesa11340() {
		try {
			// PDQ Request Message: 
			String message = "MSH|^~\\&|MESA_PD_CONSUMER|MESA_DEPARTMENT|MESA_PD_SUPPLIER|XYZ_HOSPITAL|||QBP^Q22|11311110|P|2.5||||||||\r" + 
		      "QPD|IHE PDQ Query|QRY11311110|@PID.7.1^19380224|||||^^^IHENA&1.3.6.1.4.1.21367.2010.1.2.300&ISO\r" +
		      "RCP|I|10^RD|||||";
