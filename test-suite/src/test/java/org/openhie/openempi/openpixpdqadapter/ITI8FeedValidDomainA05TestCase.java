...
public class ITI8FeedValidDomainA05TestCase extends AbstractPixTest
{
/*
		Pre-condition: 	
...
*/
	   public void testFeedValidDomainA05() {
/*
 *		Messages:
 * 
...
*/
			try {
				//Step 1
				String message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160754||ADT^A05^ADT_A01|NIST-101101160754757|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("NIST-101101160754757", msa.getMessageControlID().getValue());
				
				
				
				//Step 2
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160805||ADT^A05^ADT_A01|NIST-101101160805440|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				assertEquals("AA", msa.getAcknowledgementCode().getValue());
				assertEquals("NIST-101101160805440", msa.getMessageControlID().getValue());

				
	            //Step 3:
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160806||QBP^Q23^QBP_Q21|NIST-101101160806705|P|2.5||||||||\r" + 
				...
				assertEquals("NIST-101101160806705", msa25.getMessageControlID().getValue());
				...
				//Step 4
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160817||ADT^A05^ADT_A01|NIST-101101160817044|P|2.3.1||||||||\r" + 
					      "EVN||20101020||||\r" +
				...
				msa = (MSA)response.get("MSA");
				assertEquals("AA", msa.getAcknowledgementCode().getValue());
				assertEquals("NIST-101101160817044", msa.getMessageControlID().getValue());		
				
				
				//Step 5
				message = "MSH|^~\\&|NIST_SENDER^^|NIST^^|NIST_RECEIVER^^|NIST^^|20101101160818||QBP^Q23^QBP_Q21|NIST-101101160818528|P|2.5||||||||\r" + 
				...
				assertEquals("AA", msa25.getAcknowledgmentCode().getValue());
				assertEquals("NIST-101101160818528", msa25.getMessageControlID().getValue());
				...
				e.printStackTrace();
				fail("Fail to test FeedValidDomainA05.");
			}					
