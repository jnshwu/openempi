...
public class PixMesa10506TestCase extends AbstractPixTest
{
...
//			assertEquals("OK", qak.getQueryResponseStatus().getValue());
			...
			assertTrue(index >= 0);
			assertEquals("HIMSS2005", pid.getPatientIdentifierList(index).getAssigningAuthority().getNamespaceID().getValue());
			assertEquals("1.3.6.1.4.1.21367.2005.1.1", pid.getPatientIdentifierList(index).getAssigningAuthority().getUniversalID().getValue());
