 ...
 */
public class Hl7MessageValidationException extends IheActorException
{
	private static final long serialVersionUID = 4496513837046385313L;
		
	/**
	 * Create a new Hl7MessageValidationException.
	 * 
	 * @param string A description of the problem
	 */
	public Hl7MessageValidationException(String msg) {
		super(msg);
	}

    public Hl7MessageValidationException(String msg, Throwable cause){
        super(msg, cause);
    }
