 ...
 *         &lt;element name="location" type="{urn:hl7-org:v3}ST_explicit" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class MCCIMT000200UV01AcknowledgementDetail {
    ...
    protected List<STExplicit> location;
     ...
     * 
     */
    public List<STExplicit> getLocation() {
        if (location == null) {
            location = new ArrayList<STExplicit>();
        }
