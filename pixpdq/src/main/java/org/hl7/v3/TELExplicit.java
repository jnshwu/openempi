 ...
 *             
 * 
 * <p>Java class for TEL_explicit complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TEL_explicit">
 *   &lt;complexContent>
...
@XmlType(name = "TEL_explicit", propOrder = {
    "useablePeriod"
})
public class TELExplicit {

    protected List<SXCMTSExplicit> useablePeriod;
     ...
     * 
     */
    public List<SXCMTSExplicit> getUseablePeriod() {
        if (useablePeriod == null) {
            useablePeriod = new ArrayList<SXCMTSExplicit>();
        }
