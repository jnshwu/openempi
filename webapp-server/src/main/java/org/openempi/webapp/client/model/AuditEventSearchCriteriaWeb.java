...
public class AuditEventSearchCriteriaWeb extends BaseModelData implements Serializable
{
	@SuppressWarnings("unused")
    private AuditEventTypeWeb unusedAuditEventTypeWeb;

	public AuditEventSearchCriteriaWeb() {
	}
	
	public java.util.Set<AuditEventTypeWeb> getAuditEventTypes() {
		return get("auditEventTypes");
	}
	
	public void setAuditEventTypes(java.util.Set<AuditEventTypeWeb> auditEventTypes) {
		set("auditEventTypes", auditEventTypes);
	}
